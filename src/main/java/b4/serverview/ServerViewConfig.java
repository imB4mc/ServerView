...
public class ServerViewConfig {
    ...
    public static boolean remoteRodDetectorEnabled = true; // For "Remote rod detector"
    public static boolean entitySyncEnabled = true;        // For "Permanent entity synchronization"
    public static boolean illegalBlockDetector = true;      // For "Illegal block detector"
